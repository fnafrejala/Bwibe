                ...
                },
                {
                    ...
                    value: function (text, say, allowHtml) {
						...
						function getBonziHEXColor(color) {
						    ...
						    var popeGavelHtml = this.userPublic.color === "pope" ? "<img src='./img/pope_gavel.png' style='width:12px;height:12px;vertical-align:middle;margin-right:2px;image-rendering:pixelated;'>" : "";
    document.getElementById("chat_log_list").innerHTML += "<ul><li class=\"bonzi-message cl-msg ng-scope bonzi-event\" id=\"cl-msg-"+self.id+"\"><span class=\"timestamp ng-binding\"><small style=\"font-size:11px;font-weight:normal;\">"+date+"</small></span> <span class=\"sep tn-sep\"> | </span><span class=\"bonzi-name ng-isolate-scope\"><span class=\"event-source ng-binding ng-scope\">"+popeGavelHtml+"<font color='"+getBonziHEXColor(this.userPublic.color)+"'>"+this.userPublic.name+"</font></span></span><span class=\"sep bn-sep\">: </span><span class=\"body ng-binding ng-scope\" style=\"color:#dcdcdc;\">"+text+"</span></li></ul>";
                ...
                },
                {
                    key: "updateName",
                    value: function () {
                        if (this.userPublic.color === "pope") {
                            this.$nametag.html("<img src='./img/pope_gavel.png' style='width:14px;height:14px;vertical-align:middle;margin-right:3px;image-rendering:pixelated;'>" + $("<span>").text(this.userPublic.name).html());
                        } else {
